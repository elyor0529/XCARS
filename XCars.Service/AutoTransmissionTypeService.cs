...
{
    public class AutoTransmissionTypeService : BaseService<AutoTransmissionType>, IAutoTransmissionTypeService
    {
        public AutoTransmissionTypeService(IAutoTransmissionTypeRepository autoTransmissionTypeRepository, IUnitOfWork unitOfWork)
            : base(autoTransmissionTypeRepository, unitOfWork)
        {
        }
